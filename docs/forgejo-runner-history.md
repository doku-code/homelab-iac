# Historical CT300 Adoption Notes

Archived before CT301 consolidation. The text below records earlier observations
and decisions, not current configuration or operator instructions. Do not run
these historical commands. See forgejo-runner.md for the current target.
