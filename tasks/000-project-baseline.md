...
- **Statut :** IN_PROGRESS — intégration préparée, acceptation opérateur en attente
...
La documentation intégrée et la CI locale restent soumises à revue; aucun push
ou changement de production n'est autorisé par cette intégration.
